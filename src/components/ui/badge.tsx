  ...
  "inline-flex items-center rounded-full border border-border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        geekStyle: "border-amber-500 bg-background text-amber-600 shadow-[0_0_2px] shadow-amber-500 dark:border-yellow-400 dark:text-yellow-400 dark:shadow-yellow-400",
      },
    },
    defaultVariants: {
      variant: "default",
